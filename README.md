...
2. **CGPI (Cumulative Grade Point Index):**
...
1. **Access the Add Job Section:** Log in to your Maintainer/Recruiter/Employer account and navigate to the Add Job section.

2. **Fill in the Details:** Enter the necessary information in the intuitive form.

3. **Submit the Job Posting:** Click on the submit button, and voila! Your job is now live on JobHunt.
