                        ...
                        <div className=" py-2  relative h-420 w-full lg:h-650 ">
                            <div className="h-full flex gap-3">
                                <div className="w-1/2 gap-2 flex flex-col">
                                    {/* left */}
                                    <div className="w-full flex flex-col p-6 text-sm text-center border rounded-e-xl rounded-b-xl gap-6 shadow-md bg-white">
                                        <p>
                                ...
                                <div className="w-1/2 full gap-2 flex flex-col">
                                    {/* right */}
                                    {/* Empty Card */}
                                    <div className="w-full h-[35%] bg-lightBgBlue rounded-e-xl rounded-b-xl shadow-md"></div>
