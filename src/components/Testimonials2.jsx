  ...
  return (
    <section className="my-8 bg-gray-100 text-gray-800 bg-white">
      <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg hover:shadow-xl transition duration-300">
        ...
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg hover:shadow-xl transition duration-300">
          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-blue-600 text-gray-50">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgKbwfJTxQ7opzCr6LTaKSnLtPm2vH2uPyWIENfNu8zQ&s"
              alt=""
              className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full bg-gray-500 bg-gray-300"
            />
