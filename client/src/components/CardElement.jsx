...
const CardElement = ({ jobTitle, description, category, location, id, salary }) => {
  return (
    <div>
      <div className="hidden md:flex lg:gap-10 md:gap-2 items-center justify-center rounded-2xl border px-16 py-6 ml-auto mb-4 shadow-md bg-white">
        ...
        <div className="flex justify-end mt-4">
          ...
          <Link to={`/job/${id}`}>
            <button className="bg-lightPrimary text-lightCard md:px-7 ml-4 px-2 py-2 text-sm rounded-lg" type="submit">
              More Details
            </button>
          </Link>
        </div>
      ...
      {/* For mobile */}
      <div className="md:hidden flex flex-col lg:gap-10 items-center justify-center rounded-2xl border px-16 py-6 ml-auto mb-4 gap-2 shadow-md bg-white">
        <div className='flex flex-col '>
